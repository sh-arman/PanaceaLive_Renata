...
<script>
  ...
  gtag('config', 'UA-162782168-1');
    ...
    <link rel="stylesheet" href="{{asset('/css/public/overall.css')}}">

</head>

<body class="mups" style="height:100vh;font-family: 'Magra', sans-serif;">

    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">

        <a class="navbar-brand" href="{{url('/')}}">
            <img src="{{asset('images/logos/renata.png')}}" style="max-width:50px;" >
            <img class="ml-2" src="{{asset('images/logos/live_check.png')}}" style="max-width:100px;" >
        </a>
